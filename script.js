...
const projects = [
    ...
    { title: "Happy Birthday Siyu Dii", category: "Birthday", description: "A loving birthday tribute website.", technologies: ["HTML", "CSS", "JS"], image: "", icon: "🎀", grad: "linear-gradient(135deg, #ffc3a0, #ffafbd)", github: "", live: "https://kunaldhibar987-collab.github.io/happy-birthday-siyuu-dii/", featured: false },
